...
import 'package:huynd2_assignment/domain/shared/entity/shared_entity.dart';
import 'package:huynd2_assignment/manager/color.dart';
import 'package:huynd2_assignment/manager/enum/region_enum.dart';
import 'package:huynd2_assignment/manager/enum/status_enum.dart';
import 'package:huynd2_assignment/manager/enum/year_enum.dart';
import 'package:huynd2_assignment/manager/widget/custom_spin_widget.dart';
import 'package:huynd2_assignment/manager/widget/custom_toast.dart';
import 'package:huynd2_assignment/presentation/auth/bloc/auth_bloc.dart';
import 'package:huynd2_assignment/presentation/auth/bloc/auth_state.dart';
import 'package:huynd2_assignment/presentation/commment/bloc/comeent/comment_bloc.dart';
import 'package:huynd2_assignment/presentation/commment/bloc/comeent/comment_event.dart';
import 'package:huynd2_assignment/presentation/commment/bloc/comeent/comment_state.dart';
...
import 'package:huynd2_assignment/presentation/detail_movie/bloc/review/review_state.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/searchMovieBloc/search_movie_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/searchMovieBloc/search_movie_event.dart';
import 'package:huynd2_assignment/presentation/feed/widget/bottom_form_dialog_widget.dart';
import 'package:huynd2_assignment/presentation/feed/widget/close_button_bottom_dialog_widget.dart';
...
class AppUtils {
  ...
  static void showFilterDialog(BuildContext context, String keywordSearched) {
    ...
    final primaryReleaseYearTemp = ValueNotifier<Year>(Year.values.firstWhere(
        (year) => year.year == searchMovieBloc.state.primaryReleaseYear));
    final regionTemp = ValueNotifier<Region>(Region.values
        .firstWhere((region) => region.name == searchMovieBloc.state.region));
                    ...
                    Expanded(
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            ...
                            side: BorderSide(
                                color: TAppColor.primaryColor, width: 1.w)),
                        onPressed: () {
                          final searchBloc =
                        ...
                        onPressed: () {
                          ...
                          searchBloc.add(
                            FilteredGetMovieBySearchEvent(
                              ...
                              primaryReleaseYear:
                                  primaryReleaseYearTemp.value.year,
  ...
  static void showBottomDialogToShowAllReview(
  ...
  static void showDialogAnonymous(
      BuildContext context, User user, Function() callback) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
  ...
  static void showBottomDialogShared(
      BuildContext context, SharedEntity shared, User user) {
  ...
  static void showCommentBottomSheet(BuildContext context, String postId,
      SharedEntity sharedItem, String uid) {
      ...
      builder: (context) {
        return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return SafeArea(
              child: BlocProvider(
                create: (context) => CommentBloc(sl<CommentUseCase>())
                  ..add(GetCommentsRequested(postId)),
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            SizedBox(
                                                                              width: 40.w,
                                                                              child: Text(
                                                                                AppUtils.formatTimestamp(reply.timestamp) ?? 'No time',
                                                                                style: TextStyle(
                                                                                  color: Colors.grey,
                                                                                  fontSize: 10.sp,
                                                                                ),
  ...
  static void timerSidler(Timer timer, int currentPage,
      PageController pageController, int lengthOfMovieToShow) {
