...
import 'package:huynd2_assignment/core/internet/bloc/internet/internet_bloc.dart';

import 'package:huynd2_assignment/core/theme/bloc/theme_bloc.dart';
import 'package:huynd2_assignment/core/time_tracking/time_tracker.dart';
import 'package:huynd2_assignment/data/local/detail_tv/resource/detail_movie_cached_database.dart';
import 'package:huynd2_assignment/data/local/feed/resource/feed_cached_database.dart';
import 'package:huynd2_assignment/data/local/keyword/datasource/keyword_db_helper.dart';
import 'package:huynd2_assignment/data/local/movie/datasource/cached_db_helper.dart';
import 'package:huynd2_assignment/data/local/tv_show/datasource/cached_db_tv_show_hepler.dart';
import 'package:huynd2_assignment/data/remote/auth/auth_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/cast/api/cast_api_service.dart';
import 'package:huynd2_assignment/data/remote/cast/repository/cast_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/comment/api/comment_api_service.dart';
import 'package:huynd2_assignment/data/remote/comment/repository/comment_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/credit/api/credit_api_service.dart';
import 'package:huynd2_assignment/data/remote/credit/repository/credit_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/detail_movie/api/movie_detail_api_service.dart';
import 'package:huynd2_assignment/data/remote/detail_movie/repository/movie_detail_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/favourite/favourite_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/genres/api/genres_api_service.dart';
import 'package:huynd2_assignment/data/remote/genres/repository/genres_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/image/api/image_api_service.dart';
import 'package:huynd2_assignment/data/remote/image/repository/image_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/keyword/api/keyword_api_service.dart';
import 'package:huynd2_assignment/data/remote/keyword/repository/keyword_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/like_post/api/like_post_api_service.dart';
import 'package:huynd2_assignment/data/remote/like_post/repository/like_post_repository_impl.dart';

import 'package:huynd2_assignment/data/remote/movie/api/movie_api_service.dart';
import 'package:huynd2_assignment/data/remote/movie/repository/movie_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/people/api/people_api_service.dart';
import 'package:huynd2_assignment/data/remote/people/repository/people_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/person_detail/api/detail_person_api_service.dart';
import 'package:huynd2_assignment/data/remote/person_detail/repository/detail_person_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/review/api/review_api_service.dart';
import 'package:huynd2_assignment/data/remote/review/repository/review_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/search/api/search_api_service.dart';
import 'package:huynd2_assignment/data/remote/search/repository/search_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/shared/api/shared_api_service.dart';
import 'package:huynd2_assignment/data/remote/shared/repository/shared_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/trailer/api/trailer_api_service.dart';
import 'package:huynd2_assignment/data/remote/trailer/repository/trailer_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/tv_detail/api/tv_detail_api_service.dart';
import 'package:huynd2_assignment/data/remote/tv_detail/repository/tv_detail_repository_impl.dart';
import 'package:huynd2_assignment/data/remote/tv_show/api/tv_show_api_service.dart';
import 'package:huynd2_assignment/data/remote/tv_show/repository/tv_show_repository_impl.dart';
import 'package:huynd2_assignment/domain/auth/repository/auth_reposiory.dart';
import 'package:huynd2_assignment/domain/auth/usecase/auth_usecase.dart';
...
import 'package:huynd2_assignment/domain/comment/usecase/comment_use_case.dart';
...
import 'package:huynd2_assignment/domain/favourite/repository/favourite_repository.dart';
import 'package:huynd2_assignment/domain/favourite/usecase/favourite_usecase.dart';
...
import 'package:huynd2_assignment/domain/like_post/repository/like_post_repository.dart';
import 'package:huynd2_assignment/domain/like_post/usecase/like_post_use_case.dart';
import 'package:huynd2_assignment/domain/movie/repository/movie_reponsitory.dart';
...
import 'package:huynd2_assignment/domain/people/usecase/people_usecase.dart';
...
import 'package:huynd2_assignment/domain/search/usecase/search_usecase.dart';
import 'package:huynd2_assignment/domain/shared/repository/shared_repository.dart';
...
import 'package:huynd2_assignment/presentation/auth/bloc/auth_bloc.dart';
import 'package:huynd2_assignment/presentation/commment/bloc/comeent/comment_bloc.dart';
import 'package:huynd2_assignment/presentation/credit/bloc/credit_detail_bloc/credit_detail_bloc.dart';
...
import 'package:huynd2_assignment/presentation/detail_people/bloc/detail_persion/detail_person_bloc.dart';
...
import 'package:huynd2_assignment/presentation/downloaded_video/bloc/saved_video/saved_video_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/local/bloc/keyword/keyword_local_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/keywordBloc/keyword_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/search/search_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/searchMovieBloc/search_movie_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/tvShowBloc/tvshow_bloc.dart';
import 'package:huynd2_assignment/presentation/explore/bloc/remote/tvShowPopularBloc/tv_show_popular_bloc.dart';
import 'package:huynd2_assignment/presentation/fab_screen/bloc/favourite_bloc/favourite_bloc.dart';
import 'package:huynd2_assignment/presentation/feed/bloc/like/like_post_bloc.dart';
import 'package:huynd2_assignment/presentation/feed/bloc/shared_bloc/shared_bloc.dart';
import 'package:huynd2_assignment/presentation/feed/bloc/shared_persion/shared_persion_bloc.dart';

import 'package:huynd2_assignment/presentation/home/bloc/movie/movie_bloc.dart';
import 'package:huynd2_assignment/presentation/see_all_new_movie/bloc/new_movie/new_movie_bloc.dart';
import 'package:huynd2_assignment/presentation/home/bloc/people/people_bloc.dart';
...
import 'package:huynd2_assignment/presentation/setting/bloc/setting/setting_bloc.dart';
import 'package:huynd2_assignment/presentation/stat/bloc/stat_bloc.dart';
import 'package:huynd2_assignment/presentation/trailer/bloc/trailer/trailer_bloc.dart';
      ...
      onRequest: (options, handler) {
        if (options.extra['requiresApiKey'] == true) {
          options.queryParameters
              .putIfAbsent('api_key', () => AppConstant.apiKey);
        }
...
void _initRepository() async {
  ...
  sl.registerLazySingleton<KeywordApiService>(
      () => KeywordApiService(sl<Dio>()));
  sl.registerLazySingleton<MovieDetailApiService>(
      () => MovieDetailApiService(sl<Dio>()));
  ...
  sl.registerLazySingleton<TrailerApiService>(
      () => TrailerApiService(sl<Dio>()));
  sl.registerLazySingleton<SharedApiService>(() => SharedApiService(sl<Dio>()));
  sl.registerLazySingleton<DetailPersonApiService>(
      () => DetailPersonApiService(sl<Dio>()));
  sl.registerLazySingleton<TvDetailApiService>(
      () => TvDetailApiService(sl<Dio>()));
  ...
  sl.registerLazySingleton<CommentApiService>(
      () => CommentApiService(sl<Dio>()));
...
// Init Local Database
  ...
  sl.registerLazySingleton<CachedDetailMovieDatabase>(
      () => CachedDetailMovieDatabase());
  sl.registerLazySingleton<DatabaseTvShowCachedHelper>(
      () => DatabaseTvShowCachedHelper());
...
// Register Repository
  ...
  sl.registerLazySingleton<PeopleRepository>(
      () => PeopleRepositoryImpl(sl(), sl<DatabaseHelper>()));
  sl.registerLazySingleton<SearchRepository>(() => SearchRepositoryImpl(sl()));
  sl.registerLazySingleton<KeyWordRepository>(
      () => KeywordRepositoryImpl(sl(), sl()));
  sl.registerLazySingleton<TVShowRepository>(
      () => TVShowRepositoryImpl(sl(), sl<DatabaseTvShowCachedHelper>()));
  ...
  sl.registerLazySingleton<TrailerRepository>(
      () => TrailerRepositoryImpl(sl()));
  ...
  sl.registerLazySingleton<AuthRepository>(() => FirebaseAuthRepository(
      firebaseAuth: sl(), firestore: sl(), firebaseStorage: sl()));

  sl.registerLazySingleton<PersonDetailRepository>(
      () => DetailPersonRepositoryImpl(sl()));
  sl.registerLazySingleton<TVDetailRepository>(
      () => TVDetailRepositoryImpl(sl()));

  sl.registerLazySingleton<GenresRepository>(() => GenresRepositoryImpl(sl()));
  sl.registerLazySingleton<LikePostRepository>(
      () => LikePostRepositoryImpl(sl()));
...
void _initUseCase() {
  ...
  // Movie Use Cases
  sl.registerLazySingleton<MovieUseCase>(
      () => MovieUseCase(sl<MovieRepository>()));

  // People Use Case
  sl.registerLazySingleton<PeopleUseCase>(
      () => PeopleUseCase(sl<PeopleRepository>()));

  // Search Use Cases
  sl.registerLazySingleton<SearchUseCase>(
      () => SearchUseCase(sl<SearchRepository>()));

  sl.registerLazySingleton<KeywordRemoteUseCase>(
      () => KeywordRemoteUseCase(sl<KeyWordRepository>()));

  // Keyword Local Use Cases
  sl.registerLazySingleton<KeyWordLocalUseCase>(
      () => KeyWordLocalUseCase(sl<KeyWordRepository>()));

  // TV Show Use Cases
  sl.registerLazySingleton<TVShowUseCase>(
      () => TVShowUseCase(sl<TVShowRepository>()));

  // Detail Movie Use Cases
  sl.registerLazySingleton<DetailMovieUseCase>(
      () => DetailMovieUseCase(sl<MovieDetailRepository>()));
  sl.registerLazySingleton<CastUseCase>(
      () => CastUseCase(sl<CastRepository>()));
  sl.registerLazySingleton<ReviewUseCase>(
      () => ReviewUseCase(sl<ReviewRepository>()));
  sl.registerLazySingleton<ImageDetailUseCase>(
      () => ImageDetailUseCase(sl<ImageRepository>()));

  // Credit Use Cases
  sl.registerLazySingleton<CreditUseCase>(
      () => CreditUseCase(sl<CreditRepository>()));

  // Trailer Use Cases
  sl.registerLazySingleton<TrailerUseCase>(
      () => TrailerUseCase(sl<TrailerRepository>()));

  sl.registerLazySingleton<FavouriteUseCase>(
      () => FavouriteUseCase(sl<FavouriteRepository>()));

  ///// Shared Use Cases

  sl.registerLazySingleton<SharedPostUseCase>(
      () => SharedPostUseCase(sl<SharedRepository>()));

  sl.registerLazySingleton<DetailPersonUsecase>(
      () => DetailPersonUsecase(sl<PersonDetailRepository>()));
  sl.registerLazySingleton<TVDetailUseCase>(
      () => TVDetailUseCase(sl<TVDetailRepository>()));

  sl.registerLazySingleton<GenresUseCase>(
      () => GenresUseCase(sl<GenresRepository>()));

  sl.registerLazySingleton<LikePostUseCase>(
      () => LikePostUseCase(sl<LikePostRepository>()));

  sl.registerLazySingleton<CommentUseCase>(
      () => CommentUseCase(sl<CommentRepository>()));
}
