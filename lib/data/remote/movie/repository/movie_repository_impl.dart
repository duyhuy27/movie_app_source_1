...
class MovieRepositoryImpl extends MovieRepository {
  ...
  @override
  Future<PageResponse<List<MovieEntity>>> getTrendingMovie(
  ...
  @override
  Future<PageResponse<List<MovieResponse>>> getSimilarMovie(
      int movieId, int page) async {
    try {
      final httpResponse =
          await _movieApiService.getSimilarMovies(movieId, page: page);
      return httpResponse;
    } catch (e) {
      throw ApiException(message: e.toString());
    }
