...
import 'package:huynd2_assignment/presentation/home/widget/place_holder_image_widget.dart';
                  ...
                  SliverAppBar(
                    ...
                    flexibleSpace: Stack(
                      ...
                      children: [
                        CachedNetworkImage(
                          imageUrl:
                              '${AppConstant.imagePathUrlW500}${credit!.profilePath ?? ''}',
                          fit: BoxFit.cover,
        ...
        AnimatedSize(
          ...
          child: ConstrainedBox(
            constraints: _isExpanded
                ...
                : BoxConstraints(maxHeight: 16.sp * 7 + (3 * 7)),
            child: Text(
              widget.text,
