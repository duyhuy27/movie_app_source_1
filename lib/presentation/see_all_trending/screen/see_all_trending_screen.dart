...
import 'package:huynd2_assignment/presentation/see_all_trending/widget/build_body_widget.dart';
import 'package:huynd2_assignment/presentation/see_all_trending/widget/dropdown_time_sectio_widget.dart';
import 'package:huynd2_assignment/presentation/see_all_trending/widget/error_layout_widget.dart';
...
class _SeeAllTrendingScreenState extends State<SeeAllTrendingScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => TrendingMovieBloc(sl<MovieUseCase>())
