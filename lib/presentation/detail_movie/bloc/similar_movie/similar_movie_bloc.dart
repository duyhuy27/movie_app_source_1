...
class SimilarMovieBloc extends Bloc<SimilarMovieEvent, SimilarMovieState> {
  ...
  Future<void> _navigatorActionPop(
      NavigatorActionPopEvent event, Emitter<SimilarMovieState> emit) async {
    emit(state.copyWith(status: Status.initial));
  }

  Future<void> _getSimilarMovieList(
      GetSimilarMovieListEvent event, Emitter<SimilarMovieState> emit) async {
