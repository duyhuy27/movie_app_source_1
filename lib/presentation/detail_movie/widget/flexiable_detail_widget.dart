...
import 'package:huynd2_assignment/presentation/home/widget/genre_chip_widget.dart';
import 'package:huynd2_assignment/presentation/home/widget/shimmer_popular_item.dart';
import 'package:huynd2_assignment/presentation/trailer/screen/trailer_watch_screen.dart';

class FlexibleDetailMovieWidget extends StatefulWidget {
  final GestureTapCallback onTap;
  const FlexibleDetailMovieWidget(
      {super.key, required this.pageController, required this.onTap});

  final PageController pageController;

  @override
  State<FlexibleDetailMovieWidget> createState() =>
      _FlexibleDetailMovieWidgetState();
}
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CachedNetworkImage(
                      imageUrl: imageState.imageList[index].filePath != null &&
                              imageState
                                  .imageList[index].filePath!.isNotEmpty &&
