...
import 'package:huynd2_assignment/domain/favourite/entity/user_favourite_entity.dart';
...
import 'package:huynd2_assignment/presentation/detail_people/screen/detail_persion_screen.dart';
...
import 'package:huynd2_assignment/presentation/fab_screen/bloc/favourite_bloc/favourite_state.dart';
...
import 'package:huynd2_assignment/presentation/feed/bloc/shared_bloc/shared_state.dart';
import 'package:huynd2_assignment/presentation/home/widget/shimmer_popular_item.dart';
                                ...
                                onPressed: () {
                                  if (formKey.currentState?.validate() ==
                                    ...
                                    context.read<SharedBloc>().add(
                                        PostSharedEvent(sharedEntity: entity));
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DetailOfMovieBloc, DetailOfMovieState>(
      buildWhen: (previous, current) =>
          previous.movieDetail.id != current.movieDetail.id ||
                    ...
                    BlocConsumer<FavouriteBloc, FavouriteState>(
                      ...
                      builder: (context, state) {
                        final isFavourite = state.favourites
                            .any((favourite) => favourite.id == idMovie);
                        return Container(
                          width: 40.w,
                          height: 40.h,
                          decoration: BoxDecoration(
