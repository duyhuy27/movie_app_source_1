...
import 'package:huynd2_assignment/presentation/see_all_top_rated/widget/body_top_rated_widget.dart';
import 'package:huynd2_assignment/presentation/see_all_top_rated/widget/error_layout_widget.dart';
      ...
      child: BlocConsumer<TopRatedMovieBloc, TopRatedMovieState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: BodyTopRatedWidget(refreshController: _refreshController,state: state,uid: uid,)
          );
        },
      ),
    );
