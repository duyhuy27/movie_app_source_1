            ...
            child: SmartRefresher(
              ...
              onRefresh: () {
                context
                    ...
                    .add(const GetTopRatedMovieEvent(isRefresh: true));
              },
              onLoading: () {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (state.minVoteAverage != null &&
                      movie.voteAverage! < state.minVoteAverage!) {
                    return Container();
                  }
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        '${AppConstant.imagePathUrlOriginal}${movie.posterPath}',
                                    width: 250.w,
                                    height: 200.h,
                                    fit: BoxFit.cover,
                                  ),
