...
import 'package:huynd2_assignment/presentation/home/bloc/app_bar/app_bar_event.dart';
import 'package:huynd2_assignment/presentation/home/bloc/app_bar/app_bar_state.dart';
...
class PageViewBloc extends Bloc<PageViewEvent, PageViewState> {
  ...
  void _onPageChanged(PageChanged event, Emitter<PageViewState> emit) {
    emit(state.copyWith(
        currentPage: event.newPage, status: PageViewStateStatus.pageChanged));
  }
