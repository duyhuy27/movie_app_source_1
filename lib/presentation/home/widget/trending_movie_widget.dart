...
import 'package:huynd2_assignment/manager/widget/custom_dialog_widget.dart';
...
class TrendingMoviesWidget extends StatefulWidget {
  ...
  TrendingMoviesWidget(
      {required this.uid, required this.user, super.key, required this.state});
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => MovieDetailScreen(
                        idMovie: movieItem.id ?? 0, uid: widget.uid),
                  ),
                );
              },
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<FavouriteBloc, FavouriteState>(
      ...
      builder: (context, state) {
        isFavourite =
            state.favourites.any((favourite) => favourite.id == movieId);
        return Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          if (isFavourite) {
                            context
                                .read<FavouriteBloc>()
                                .add(RemoveFavourite(uid, movieId));
                          } else {
