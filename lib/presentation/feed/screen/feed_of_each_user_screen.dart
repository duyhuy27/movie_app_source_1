...
import 'package:huynd2_assignment/presentation/feed/bloc/shared_persion/shared_persion_event.dart';
import 'package:huynd2_assignment/presentation/feed/bloc/shared_persion/shared_persion_state.dart';
import 'package:huynd2_assignment/presentation/feed/widget/error_status_widget.dart';
import 'package:huynd2_assignment/presentation/feed/widget/post_body_image_widget.dart';
import 'package:huynd2_assignment/presentation/feed/widget/post_bottom_widget.dart';
import 'package:huynd2_assignment/presentation/feed/widget/user_header_widget.dart';
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              UserHeader(
                                  sharedItem: sharedItem, uid: uid, user: user),
                              10.verticalSpace,
                              PostBodyImageWidget(
                                  sharedItem: sharedItem, uid: uid),
                              PostBottomWidget(
