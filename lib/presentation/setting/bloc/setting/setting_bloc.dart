...
class SettingBloc extends Bloc<SettingEvent, SettingState> {
  ...
  Future<void> _onLoadPreferences(
      LoadPreferencesEvent event, Emitter<SettingState> emit) async {
  ...
  Future<void> _onChangeLanguage(
      ChangeLanguageEvent event, Emitter<SettingState> emit) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
  ...
  Future<void> _onChangeTheme(
      ChangeThemeEvent event, Emitter<SettingState> emit) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    await pref.setBool('theme_${state.uid}', event.isDarkMode);
    emit(state.copyWith(isDarkMode: event.isDarkMode));
  }

  Future<void> _onChangeNotification(
      ChangeNotificationEvent event, Emitter<SettingState> emit) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
