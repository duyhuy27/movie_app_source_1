...
import 'package:huynd2_assignment/presentation/credit/widget/banner_sliver_appbar_credit_widget.dart';
...
class _CreditDetailScreenState extends State<CreditDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => CreditDetailBloc(sl<CreditUseCase>())
        ..add(GetDetailCreditEvent(id: id)),
      child: Scaffold(
        ...
        AnimatedSize(
          ...
          child: ConstrainedBox(
            constraints: _isExpanded
                ...
                : BoxConstraints(maxHeight: 16.sp * 5 + (3 * 5)),
            child: Text(
              widget.text,
