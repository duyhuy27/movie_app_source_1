...
import 'package:huynd2_assignment/presentation/explore/widget/bloc_widget/show_keyword_local_section_widget.dart';
import 'package:huynd2_assignment/presentation/explore/widget/bloc_widget/show_keyword_search_for_widget.dart';
import 'package:huynd2_assignment/presentation/explore/widget/bloc_widget/show_result_keyword_when_search_widget.dart';

class SearchKeywordResultScreen extends StatefulWidget {
  const SearchKeywordResultScreen({super.key});

  @override
  State<SearchKeywordResultScreen> createState() =>
      _SearchKeywordResultScreenState();
}
