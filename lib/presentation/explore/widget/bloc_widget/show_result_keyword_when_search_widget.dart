...
class ShowResultKeywordWhenSearchWidget extends StatelessWidget {
  ...
  const ShowResultKeywordWhenSearchWidget(
      {super.key, required this.clearSearch});
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    context.read<KeywordLocalBloc>().add(
                        AddKeywordEvent(keyword: itemKeyword.name ?? 'NaN'));
                    clearSearch();
                    Navigator.push(
                        context,
                        MaterialPageRoute(
