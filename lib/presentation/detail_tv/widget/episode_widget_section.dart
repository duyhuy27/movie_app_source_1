...
import 'package:huynd2_assignment/presentation/detail_tv/widget/all_episode_widget.dart';
import 'package:huynd2_assignment/presentation/detail_tv/widget/last_episode_widget.dart';
import 'package:huynd2_assignment/presentation/detail_tv/widget/next_episode_widget.dart';
      ...
      switch (_selectedOption) {
        case 'Last Episode':
          if (lastEpisode != null) {
            return [
              LastEpisodeWidget(
                  lastEpisode: lastEpisode!, tvDetailEntity: tvDetailEntity),
            ];
          } else {
            return [
              const Center(
        ...
        case 'Next Episode':
          if (nextEpisode != null) {
            return [
              NextEpisodeWidget(
                  nextEpisode: nextEpisode!, tvDetailEntity: tvDetailEntity),
            ];
          } else {
            return [
              const Center(
          ...
          DropdownButtonFormField<String>(
            ...
            style: TextStyle(
                color: Theme.of(context).brightness == Brightness.dark
                    ...
                    : TAppColor.darkBlueColor,
                fontSize: 16),
            items: ['All Episodes', 'Last Episode', 'Next Episode']
                .map((String value) {
