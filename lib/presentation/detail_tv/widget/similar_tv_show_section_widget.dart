...
class SimilarTvShowSectionWidget extends StatefulWidget {
  ...
  @override
  State<SimilarTvShowSectionWidget> createState() =>
      _SimilarTvShowSectionWidgetState();
}

class _SimilarTvShowSectionWidgetState
    extends State<SimilarTvShowSectionWidget> {
  @override
  void initState() {
    super.initState();
    context
                          ...
                          ElevatedButton(
                            onPressed: () {
                              context.read<SimilarTvShowBloc>().add(
                                  GetSimilarTVEvent(
                                      widget.tvDetailEntity.id.toString()));
                            },
