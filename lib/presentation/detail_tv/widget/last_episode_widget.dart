...
class LastEpisodeWidget extends StatelessWidget {
  ...
  const LastEpisodeWidget(
      {super.key, required this.lastEpisode, required this.tvDetailEntity});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            10.verticalSpace,
                            Text(
                              '${lastEpisode.runtime.toString()} minutes',
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                fontSize: 12.sp,
              ...
              10.verticalSpace,
              Text(
                lastEpisode.overview!.isEmpty
                    ? 'No overview available'
                    : lastEpisode.overview.toString(),
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
