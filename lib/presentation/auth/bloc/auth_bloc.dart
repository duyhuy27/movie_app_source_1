...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  Future<void> _updateImageEvent(
      UpdateImageEvent event, Emitter<AuthState> emit) async {
  ...
  Future<void> _getInformationEvent(
      GetInformationEvent event, Emitter<AuthState> emit) async {
  ...
  Future<void> _updateUsernameEvent(
