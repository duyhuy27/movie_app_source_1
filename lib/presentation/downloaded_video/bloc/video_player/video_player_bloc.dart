...
import 'package:huynd2_assignment/presentation/downloaded_video/bloc/video_player/video_player_event.dart';
import 'package:huynd2_assignment/presentation/downloaded_video/bloc/video_player/video_player_state.dart';
    ...
    if (event is InitializeVideo) {
      ...
      try {
        ...
        yield state.copyWith(
            status: VideoStatus.loaded, controller: controller);
      } catch (error) {
        yield state.copyWith(
            status: VideoStatus.error, errorMessage: error.toString());
      }
