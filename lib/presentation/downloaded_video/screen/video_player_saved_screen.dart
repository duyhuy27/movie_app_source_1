...
import 'package:huynd2_assignment/presentation/downloaded_video/widget/error_video_player_widget.dart';
...
class VideoPlayerScreen extends StatefulWidget {
  ...
  const VideoPlayerScreen(
      {super.key, required this.filePath, required this.name});
